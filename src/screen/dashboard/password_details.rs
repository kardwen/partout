    ...
    pub fn view(&self) -> Element<Message> {
        ...
        if let Some(ref entry) = self.entry {
            header = if self.show_secrets {
                header.push(
                    button(
                        row!["Hide secrets", horizontal_space(), icons::visible()]
                            .width(125)
                            .align_y(Center),
                    )
                ...
                header.push(
                    button(
                        row!["Show secrets", horizontal_space(), icons::hidden()]
                            .width(125)
                            .align_y(Center),
                    )
            ...
            content = content.push(password_field(
                ...
                &entry.pass_id,
                vec![
                    button(row!["Copy", icons::clipboard()].spacing(8).align_y(Center))
            ...
            if let Some(ref otp) = self.otp {
                content = if self.show_secrets {
                    content.push(password_field(
                        ...
                        otp,
                        vec![
                            button(row!["Refresh", icons::refresh()].spacing(8).align_y(Center))
